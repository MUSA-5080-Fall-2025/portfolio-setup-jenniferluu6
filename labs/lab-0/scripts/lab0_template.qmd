...
- Problematic names: [Some of the models have numbers and letters with spaces]
...
**Your answer:** [The tibble table only shows the first 6 rows, but when you print it as a regular data frame it prints the entire dataset]
...
# group_by(car_data, Manufacturer = "Toyota")
# group_by(car_data, Manufacturer = "Toyota")

# Find cars with mileage less than 30,000
car_data %>%
  group_by(LowMileage = Mileage < 30000)
